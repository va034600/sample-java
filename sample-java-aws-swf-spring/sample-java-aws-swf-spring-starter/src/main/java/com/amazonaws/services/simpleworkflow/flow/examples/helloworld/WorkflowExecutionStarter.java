...
public class WorkflowExecutionStarter {
    ...
    public static void main(String[] args) throws Exception {
        ApplicationContext appContext = new ClassPathXmlApplicationContext(
                "DeploymentInitiator-context.xml");

        HelloWorldWorkflowClientExternalFactory clientFactory = appContext.getBean("workflowFactory",
        		HelloWorldWorkflowClientExternalFactory.class);
